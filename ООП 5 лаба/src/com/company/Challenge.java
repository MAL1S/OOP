...
//
//public class Challenge implements IListManageable{
//    public final List<Attestation> challengeList = new ArrayList<>();
//
//    @Override
//    public void add(Attestation attestation) {
//        challengeList.add(attestation);
//    }
//
//    @Override
//    public void remove(Attestation attestation) {
//        challengeList.removeIf(item -> item.getSubject().equals(attestation.subject) && item.getTeacherName().equals(attestation.teacherName)
//                && item.getTeacherSurname().equals(attestation.teacherSurname) && item.getDay() == attestation.day && item.getMonth() == attestation.month
//                && item.getHour() == attestation.hour && item.getMinute() == attestation.minute);
//    }
//

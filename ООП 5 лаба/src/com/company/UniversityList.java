...
//
//public class UniversityList implements IListManageable{
...
//            return;
//        }
//        //if (attestation instanceof Exam) challenges.add(new Exam(subject, day, month, hour, minute, teacherName, teacherSurname));
//        //else if (attestation instanceof Test) challenges.add(new Test(subject, day, month, hour, minute, teacherName, teacherSurname));
//        //else return;
//        challenges.add(attestation);
